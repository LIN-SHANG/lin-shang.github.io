...
- 关于n元语法语言模型的大量研究（用于机器翻译、语音识别） [Brants等人 2007](https://aclanthology.org/D07-1090.pdf)

### 神经组件（21世纪10年代）
- 首个神经语言模型 [Bengio等人 2003](https://www.jmlr.org/papers/volume3/bengio03a/bengio03a.pdf)
- 序列到序列建模（用于机器翻译） [Sutskever等人 2014](https://arxiv.org/pdf/1409.3215.pdf)
- Adam优化器 [Kingma等人 2014](https://arxiv.org/pdf/1412.6980.pdf)
- 注意力机制（用于机器翻译） [Bahdanau等人 2014](https://arxiv.org/pdf/1409.0473.pdf)
- Transformer架构（用于机器翻译） [Vaswani等人 2017](https://arxiv.org/pdf/1706.03762.pdf)
- 专家混合模型 [Shazeer等人 2017](https://arxiv.org/pdf/1701.06538.pdf)
- 模型并行化 [Huang等人 2018](https://arxiv.org/pdf/1811.06965.pdf)[Rajbhandari等人 2019](https://arxiv.org/abs/1910.02054)[Shoeybi等人 2019](https://arxiv.org/pdf/1909.08053.pdf)

### 早期基础模型（21世纪10年代末）
- ELMo：基于LSTM的预训练，微调对任务有帮助 [Peters等人 2018](https://arxiv.org/abs/1802.05365)
- BERT：基于Transformer的预训练，微调对任务有帮助 [Devlin等人 2018](https://arxiv.org/abs/1810.04805)
- 谷歌的T5（110亿参数）：将所有内容转化为文本到文本的形式 [Raffel等人 2019](https://arxiv.org/pdf/1910.10683.pdf)

### 迈向规模化，更封闭
- OpenAI的GPT-2（15亿参数）：文本流畅，首次出现零样本迹象，分阶段发布 [Radford等人 2019](https://cdn.openai.com/better-language-models/language_models_are_unsupervised_multitask_learners.pdf)
- 缩放定律：为规模化提供希望和可预测性 [Kaplan等人 2020](https://arxiv.org/pdf/2001.08361.pdf)
- OpenAI的GPT-3（1750亿参数）：上下文学习，封闭模型 [Brown等人 2020](https://arxiv.org/pdf/2005.14165.pdf)
- 谷歌的PaLM（5400亿参数）：规模庞大，训练不足 [Chowdhery等人 2022](https://arxiv.org/pdf/2204.02311.pdf)
- DeepMind的Chinchilla（700亿参数）：计算最优缩放定律 [Hoffmann等人 2022](https://arxiv.org/pdf/2203.15556.pdf)

### 开源模型
- EleutherAI的开源数据集（The Pile）和模型（GPT-J） [Gao等人 2020][Wang等人 2021](https://arxiv.org/pdf/2101.00027.pdf)[wang+ 2021](https://arankomatsuzaki.wordpress.com/2021/06/04/gpt-j/)
- 元宇宙的OPT（1750亿参数）：GPT-3的复现，存在诸多硬件问题 [Zhang等人 2022](https://arxiv.org/pdf/2205.01068.pdf)
- Hugging Face / BigScience的BLOOM：专注于数据来源 [Workshop等人 2022](https://arxiv.org/abs/2211.05100)
- 元宇宙的Llama模型 [Touvron等人 2023](https://arxiv.org/pdf/2302.13971.pdf)[Touvron等人 2023](https://arxiv.org/pdf/2307.09288.pdf)[Grattafiori等人 2024](https://arxiv.org/abs/2407.21783)
- 阿里巴巴的通义千问（Qwen）模型 [Qwen等人 2024](https://arxiv.org/abs/2412.15115)
- 深度求索（DeepSeek）的模型 [DeepSeek-AI等人 2024](https://arxiv.org/pdf/2401.02954.pdf)[DeepSeek-AI等人 2024](https://arxiv.org/abs/2405.04434)[DeepSeek-AI等人 2024](https://arxiv.org/pdf/2412.19437.pdf)
- AI2的OLMo 2 [Groeneveld等人 2024](https://arxiv.org/pdf/2402.00838.pdf)[OLMo等人 2024](https://arxiv.org/abs/2501.00656)

### 开放程度
- 封闭模型（例如，GPT-4o）：仅提供API访问 [OpenAI等人 2023](https://arxiv.org/pdf/2303.08774.pdf)
- 开源权重模型（例如，深度求索模型）：提供权重，包含架构细节的论文，部分训练细节，无数据细节 [DeepSeek-AI等人 2024](https://arxiv.org/pdf/2412.19437.pdf)
- 开源模型（例如，OLMo）：提供权重和数据，包含大部分细节的论文（但不一定包含原理、失败的实验） [Groeneveld等人 2024](https://arxiv.org/pdf/2402.00838.pdf)
